...
- `nvim-lualine/lualine.nvim` integration.
...
> [!Warning]
> For now it doesn't support most of the config options from above-mentioned plugins except those mentioned in the installation section.
